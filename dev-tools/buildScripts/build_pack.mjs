...
import { CONTENT_ITEMS } from "../../data/index.mjs";
...
for ( const source of CONTENT_ITEMS ) {
  ...
  item._stats = {
    ...
    systemId: "dnd5e",
    systemVersion: "5.2.0",
    createdTime: Date.UTC(2026, 7, 29),
    modifiedTime: Date.UTC(2026, 7, 29),
    lastModifiedBy: null,
    exportSource: null
  };
...
await db.close();
console.log(`Pack generado: ${CONTENT_ITEMS.length} Items en ${packPath}`);
